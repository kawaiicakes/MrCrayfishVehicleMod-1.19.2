...
public class ImprovedSlider extends Slider
{
    ...
    {
        super(xPos, yPos, width, height, MutableComponent.create(new LiteralContents(prefix), MutableComponent.create(new LiteralContents(suf), minVal, maxVal, currentVal, showDec, drawStr, b -> {});
