...
public class BakedModelSteepRamp
{
    ...
    static
    {
        ...
        builder.put(ItemTransforms.TransformType.GUI, new TransformationBuilder().setTranslation(0.1F, 0, 0).setRotation(30.0F, 45.0F, 0).setScale(0.625F).build().getMatrix());
    ...
    public BakedModelSteepRamp(DefaultVertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
        this.format = format;
